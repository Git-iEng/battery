...
def request_demo_view(request):
    ...
    subject = "New battery inquiry"
    text_body = (
        "A new battery inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New battery Inquiry Request</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for battery Inquiry"
        text_body = "\n".join(
            [
                "New contact submission for battery Inquiry:",
